  ...
  template: `
    ...
    <div class="page-container">
      ...
      <div class="content">
        ...
        <div class="export-row" *ngIf="transactions.length > 0">
...
export class HistoryComponent implements OnInit {
  ...
  downloadCsv(): void {
    this.api.download('/api/wallet/history/export/csv',
      `wallet-history-${new Date().toISOString().slice(0, 10)}.csv`);
  }

  downloadPdf(): void {
    this.api.download('/api/wallet/history/export/pdf',
      `wallet-history-${new Date().toISOString().slice(0, 10)}.pdf`);
  }
}
